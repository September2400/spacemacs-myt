...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ;; zilongshanren mirror form elpa
...
before packages are loaded."
  ...
  ;;(setq ycmd-server-command '("/usr/bin/python2" "/workspace/tools/emacs/ycmd/ycmd"))
  ...
  ;;(setq ycmd-global-config "/workspace/tools/emacs/ycmd/ycm_extra_conf.py")
